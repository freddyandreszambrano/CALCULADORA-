class calculadora{
    ...
    calcularBilletes() {
      ...
      PalabraOracion = () => {
        ...
        let cadenaFinal = " ";
        if(respuest == ""){
           $input.value = `No se han ingresado digitos`
        }else{
           for(let i = 0; i < longitud; i++){
    ...
    eliminarElementoArreglo() {
      ...
      insertarElementoArreglo() {
        ...
        func.insertarElemento(nuevo,arreglo)
        $input.value = `[Arreglo inicial=${cadena}] ==> Arreglo nuevo=${arreglo}`;
    ...
    MayorArreglo(){
        ...
        let mayor = numeros[0];
        func.numeroMayor(numeros,mayor)
    ...
    MenorArreglo(){
        ...
        let numeros = func.spliter(cadena,";").map(Number);
        let menor = numeros[0];
        func.numeroMenor(numeros,menor)
    }
    ...
    buscar_cadena() {
      ...
      func.encontrarCadena(cadena,subcadena)
    ...
    BaseN_N() {
      ...
      //convertimos el número a base 10
      let base10= func.Tobase10(baseInicial,numero)
      //De base 10 convertimos a cualquier otra base
      $input.value = `[Base${baseInicial}=${numero}] ==> Base${baseFinal}=${func.base10toCualquierbase(base10, baseFinal)}`;
    }
...
class funciones{
    ...
    insertarElemento(nuevo,arreglo){
      let posicion = 0;
    ...
    encontrarCadena(cadena,subcadena){
    ...
    base10toCualquierbase(base10, baseFinal){
